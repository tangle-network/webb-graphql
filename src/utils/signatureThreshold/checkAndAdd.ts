import { lastSignatureThreshold as lastThreshold, SignatureThresholdProps } from '.';
 ...
 */
export const checkAndAddSignatureThreshold = async (block: Block): Promise<boolean> => {
