...
export class VAnchorDemeter___genExtDataHashInput_externalDataStruct extends ethereum.Tuple {
...
export class VAnchorDemeter___genExtDataHashInput_encryptionsStruct extends ethereum.Tuple {
...
export class VAnchorDemeter__edgeListResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: Bytes;
...
export class VAnchorDemeter__getLatestNeighborEdgesResultValue0Struct extends ethereum.Tuple {
  get chainID(): BigInt {
...
export class VAnchorDemeter__rootsResult {
  value0: BigInt;
  value1: BigInt;
...
export class VAnchorDemeter__unpackProofResult {
  value0: Array<BigInt>;
...
export class VAnchorDemeter extends ethereum.SmartContract {
  static bind(address: Address): VAnchorDemeter {
    return new VAnchorDemeter("VAnchorDemeter", address);
  }
  ...
  _genExtDataHash(
    param0: Bytes,
    _externalData: VAnchorDemeter___genExtDataHashInput_externalDataStruct,
    _encryptions: VAnchorDemeter___genExtDataHashInput_encryptionsStruct
  ): Bytes {
    let result = super.call(
      "_genExtDataHash",
  ...
  edgeList(param0: BigInt): VAnchorDemeter__edgeListResult {
    let result = super.call(
      "edgeList",
    ...
    return new VAnchorDemeter__edgeListResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBytes()
  ...
  try_edgeList(
    param0: BigInt
  ): ethereum.CallResult<VAnchorDemeter__edgeListResult> {
    let result = super.tryCall(
      "edgeList",
      "edgeList(uint256):(uint256,uint256,uint256,bytes32)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
    ...
    return ethereum.CallResult.fromValue(
      new VAnchorDemeter__edgeListResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBytes()
  ...
  getLatestNeighborEdges(): Array<
    VAnchorDemeter__getLatestNeighborEdgesResultValue0Struct
  > {
    let result = super.call(
  ...
  try_getLatestNeighborEdges(): ethereum.CallResult<
    Array<VAnchorDemeter__getLatestNeighborEdgesResultValue0Struct>
  > {
    let result = super.tryCall(
      "getLatestNeighborEdges",
      "getLatestNeighborEdges():((uint256,uint256,uint256,bytes32)[])",
  ...
  roots(param0: BigInt): VAnchorDemeter__rootsResult {
    let result = super.call("roots", "roots(uint256):(uint256,uint32)", [
      ethereum.Value.fromUnsignedBigInt(param0)
    ]);

    return new VAnchorDemeter__rootsResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }

  try_roots(param0: BigInt): ethereum.CallResult<VAnchorDemeter__rootsResult> {
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new VAnchorDemeter__rootsResult(value[0].toBigInt(), value[1].toBigInt())
    );
  }
  ...
  unpackProof(_proof: Array<BigInt>): VAnchorDemeter__unpackProofResult {
    let result = super.call(
      "unpackProof",
    ...
    return new VAnchorDemeter__unpackProofResult(
  ...
  try_unpackProof(
    _proof: Array<BigInt>
  ): ethereum.CallResult<VAnchorDemeter__unpackProofResult> {
    let result = super.tryCall(
      "unpackProof",
      "unpackProof(uint256[8]):(uint256[2],uint256[2][2],uint256[2])",
      [ethereum.Value.fromUnsignedBigIntArray(_proof)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new VAnchorDemeter__unpackProofResult(
