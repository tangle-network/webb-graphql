...
import { VAnchorTotalWrappingFeeByTokenEvery15Min, VAnchorTotalWrappingFee15Min } from '../../generated/schema';
...
export function recordFeeFor15MinsInterval(vAnchorAddress: Bytes, tokenAddress: Bytes, fees: BigInt, time: BigInt): void {
    ...
    if (!vanchorFeeByToken) {
        const newVanchorFeeByToken = new VAnchorTotalWrappingFeeByTokenEvery15Min(id);
