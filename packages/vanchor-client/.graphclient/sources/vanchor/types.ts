...
export namespace VanchorTypes {
  ...
  export type PublicInputs_filter = {
    ...
    outputCommitments_not_contains_nocase?: InputMaybe<
  ...
  export type VAnchorTotalValueLockedByTokenByDay_filter = {
    ...
    _change_block?: InputMaybe<BlockChangedFilter>;
    and?: InputMaybe<
      Array<InputMaybe<VAnchorTotalValueLockedByTokenByDay_filter>>
    >;
    or?: InputMaybe<
      Array<InputMaybe<VAnchorTotalValueLockedByTokenByDay_filter>>
    >;
  ...
  export type VAnchorTotalValueLockedEvery15Min_filter = {
    ...
    _change_block?: InputMaybe<BlockChangedFilter>;
    and?: InputMaybe<
      Array<InputMaybe<VAnchorTotalValueLockedEvery15Min_filter>>
    >;
    or?: InputMaybe<
      Array<InputMaybe<VAnchorTotalValueLockedEvery15Min_filter>>
    >;
  ...
  export type VAnchorWithdrawalByTokenEveryDay_filter = {
    ...
    _change_block?: InputMaybe<BlockChangedFilter>;
    and?: InputMaybe<
      Array<InputMaybe<VAnchorWithdrawalByTokenEveryDay_filter>>
    >;
  ...
  export type QuerySdk = {
    /** null **/
    edgeAddition: InContextSdkMethod<
      Query['edgeAddition'],
      QueryedgeAdditionArgs,
      MeshContext
    >;
    /** null **/
    edgeAdditions: InContextSdkMethod<
      Query['edgeAdditions'],
      QueryedgeAdditionsArgs,
      MeshContext
    >;
    /** null **/
    edgeUpdate: InContextSdkMethod<
      Query['edgeUpdate'],
      QueryedgeUpdateArgs,
      MeshContext
    >;
    /** null **/
    edgeUpdates: InContextSdkMethod<
      Query['edgeUpdates'],
      QueryedgeUpdatesArgs,
      MeshContext
    >;
    /** null **/
    insertion: InContextSdkMethod<
      Query['insertion'],
      QueryinsertionArgs,
      MeshContext
    >;
    /** null **/
    insertions: InContextSdkMethod<
      Query['insertions'],
      QueryinsertionsArgs,
      MeshContext
    >;
    /** null **/
    newCommitment: InContextSdkMethod<
      Query['newCommitment'],
      QuerynewCommitmentArgs,
      MeshContext
    >;
    /** null **/
    newCommitments: InContextSdkMethod<
      Query['newCommitments'],
      QuerynewCommitmentsArgs,
      MeshContext
    >;
    /** null **/
    newNullifier: InContextSdkMethod<
      Query['newNullifier'],
      QuerynewNullifierArgs,
      MeshContext
    >;
    /** null **/
    newNullifiers: InContextSdkMethod<
      Query['newNullifiers'],
      QuerynewNullifiersArgs,
      MeshContext
    >;
    /** null **/
    publicKey: InContextSdkMethod<
      Query['publicKey'],
      QuerypublicKeyArgs,
      MeshContext
    >;
    /** null **/
    publicKeys: InContextSdkMethod<
      Query['publicKeys'],
      QuerypublicKeysArgs,
      MeshContext
    >;
    ...
    /** null **/
    externalData: InContextSdkMethod<
      Query['externalData'],
      QueryexternalDataArgs,
      MeshContext
    >;
    /** null **/
    externalDatas: InContextSdkMethod<
      Query['externalDatas'],
      QueryexternalDatasArgs,
      MeshContext
    >;
    /** null **/
    publicInputs: InContextSdkMethod<
      Query['publicInputs'],
      QuerypublicInputsArgs,
      MeshContext
    >;
    /** null **/
    encryptions: InContextSdkMethod<
      Query['encryptions'],
      QueryencryptionsArgs,
      MeshContext
    >;
    /** null **/
    shieldedTransaction: InContextSdkMethod<
      Query['shieldedTransaction'],
      QueryshieldedTransactionArgs,
      MeshContext
    >;
    /** null **/
    shieldedTransactions: InContextSdkMethod<
      Query['shieldedTransactions'],
      QueryshieldedTransactionsArgs,
      MeshContext
    >;
    /** null **/
    vanchorTotalValueLocked: InContextSdkMethod<
      Query['vanchorTotalValueLocked'],
      QueryvanchorTotalValueLockedArgs,
      MeshContext
    >;
    /** null **/
    vanchorTotalValueLockeds: InContextSdkMethod<
      Query['vanchorTotalValueLockeds'],
      QueryvanchorTotalValueLockedsArgs,
      MeshContext
    >;
    /** null **/
    vanchorTotalValueLockedByToken: InContextSdkMethod<
      Query['vanchorTotalValueLockedByToken'],
      QueryvanchorTotalValueLockedByTokenArgs,
      MeshContext
    >;
    /** null **/
    vanchorTotalValueLockedByTokens: InContextSdkMethod<
      Query['vanchorTotalValueLockedByTokens'],
      QueryvanchorTotalValueLockedByTokensArgs,
      MeshContext
    >;
    /** null **/
    vanchorTotalValueLockedEvery15Min: InContextSdkMethod<
      Query['vanchorTotalValueLockedEvery15Min'],
      QueryvanchorTotalValueLockedEvery15MinArgs,
      MeshContext
    >;
    /** null **/
    vanchorTotalValueLockedEvery15Mins: InContextSdkMethod<
      Query['vanchorTotalValueLockedEvery15Mins'],
      QueryvanchorTotalValueLockedEvery15MinsArgs,
      MeshContext
    >;
    /** null **/
    vanchorTotalValueLockedByTokenEvery15Min: InContextSdkMethod<
      Query['vanchorTotalValueLockedByTokenEvery15Min'],
      QueryvanchorTotalValueLockedByTokenEvery15MinArgs,
      MeshContext
    >;
    /** null **/
    vanchorTotalValueLockedByTokenEvery15Mins: InContextSdkMethod<
      Query['vanchorTotalValueLockedByTokenEvery15Mins'],
      QueryvanchorTotalValueLockedByTokenEvery15MinsArgs,
      MeshContext
    >;
    /** null **/
    vanchorTotalValueLockedByDay: InContextSdkMethod<
      Query['vanchorTotalValueLockedByDay'],
      QueryvanchorTotalValueLockedByDayArgs,
      MeshContext
    >;
    /** null **/
    vanchorTotalValueLockedByDays: InContextSdkMethod<
      Query['vanchorTotalValueLockedByDays'],
      QueryvanchorTotalValueLockedByDaysArgs,
      MeshContext
    >;
    /** null **/
    vanchorTotalValueLockedByTokenByDay: InContextSdkMethod<
      Query['vanchorTotalValueLockedByTokenByDay'],
      QueryvanchorTotalValueLockedByTokenByDayArgs,
      MeshContext
    >;
    /** null **/
    vanchorTotalValueLockedByTokenByDays: InContextSdkMethod<
      Query['vanchorTotalValueLockedByTokenByDays'],
      QueryvanchorTotalValueLockedByTokenByDaysArgs,
      MeshContext
    >;
    /** null **/
    vanchorTotalRelayerFee: InContextSdkMethod<
      Query['vanchorTotalRelayerFee'],
      QueryvanchorTotalRelayerFeeArgs,
      MeshContext
    >;
    /** null **/
    vanchorTotalRelayerFees: InContextSdkMethod<
      Query['vanchorTotalRelayerFees'],
      QueryvanchorTotalRelayerFeesArgs,
      MeshContext
    >;
    /** null **/
    vanchorTotalRelayerFeeByToken: InContextSdkMethod<
      Query['vanchorTotalRelayerFeeByToken'],
      QueryvanchorTotalRelayerFeeByTokenArgs,
      MeshContext
    >;
    /** null **/
    vanchorTotalRelayerFeeByTokens: InContextSdkMethod<
      Query['vanchorTotalRelayerFeeByTokens'],
      QueryvanchorTotalRelayerFeeByTokensArgs,
      MeshContext
    >;
    /** null **/
    vanchorTotalRelayerFee15Min: InContextSdkMethod<
      Query['vanchorTotalRelayerFee15Min'],
      QueryvanchorTotalRelayerFee15MinArgs,
      MeshContext
    >;
    /** null **/
    vanchorTotalRelayerFee15Mins: InContextSdkMethod<
      Query['vanchorTotalRelayerFee15Mins'],
      QueryvanchorTotalRelayerFee15MinsArgs,
      MeshContext
    >;
    /** null **/
    vanchorTotalRelayerFeeByTokenEvery15Min: InContextSdkMethod<
      Query['vanchorTotalRelayerFeeByTokenEvery15Min'],
      QueryvanchorTotalRelayerFeeByTokenEvery15MinArgs,
      MeshContext
    >;
    /** null **/
    vanchorTotalRelayerFeeByTokenEvery15Mins: InContextSdkMethod<
      Query['vanchorTotalRelayerFeeByTokenEvery15Mins'],
      QueryvanchorTotalRelayerFeeByTokenEvery15MinsArgs,
      MeshContext
    >;
    /** null **/
    vanchorTotalWrappingFee: InContextSdkMethod<
      Query['vanchorTotalWrappingFee'],
      QueryvanchorTotalWrappingFeeArgs,
      MeshContext
    >;
    /** null **/
    vanchorTotalWrappingFees: InContextSdkMethod<
      Query['vanchorTotalWrappingFees'],
      QueryvanchorTotalWrappingFeesArgs,
      MeshContext
    >;
    /** null **/
    vanchorTotalWrappingFeeByToken: InContextSdkMethod<
      Query['vanchorTotalWrappingFeeByToken'],
      QueryvanchorTotalWrappingFeeByTokenArgs,
      MeshContext
    >;
    /** null **/
    vanchorTotalWrappingFeeByTokens: InContextSdkMethod<
      Query['vanchorTotalWrappingFeeByTokens'],
      QueryvanchorTotalWrappingFeeByTokensArgs,
      MeshContext
    >;
    /** null **/
    vanchorTotalWrappingFee15Min: InContextSdkMethod<
      Query['vanchorTotalWrappingFee15Min'],
      QueryvanchorTotalWrappingFee15MinArgs,
      MeshContext
    >;
    /** null **/
    vanchorTotalWrappingFee15Mins: InContextSdkMethod<
      Query['vanchorTotalWrappingFee15Mins'],
      QueryvanchorTotalWrappingFee15MinsArgs,
      MeshContext
    >;
    /** null **/
    vanchorTotalWrappingFeeByTokenEvery15Min: InContextSdkMethod<
      Query['vanchorTotalWrappingFeeByTokenEvery15Min'],
      QueryvanchorTotalWrappingFeeByTokenEvery15MinArgs,
      MeshContext
    >;
    /** null **/
    vanchorTotalWrappingFeeByTokenEvery15Mins: InContextSdkMethod<
      Query['vanchorTotalWrappingFeeByTokenEvery15Mins'],
      QueryvanchorTotalWrappingFeeByTokenEvery15MinsArgs,
      MeshContext
    >;
    /** null **/
    wrappingEventLog: InContextSdkMethod<
      Query['wrappingEventLog'],
      QuerywrappingEventLogArgs,
      MeshContext
    >;
    /** null **/
    wrappingEventLogs: InContextSdkMethod<
      Query['wrappingEventLogs'],
      QuerywrappingEventLogsArgs,
      MeshContext
    >;
    /** null **/
    unwrappingEventLog: InContextSdkMethod<
      Query['unwrappingEventLog'],
      QueryunwrappingEventLogArgs,
      MeshContext
    >;
    /** null **/
    unwrappingEventLogs: InContextSdkMethod<
      Query['unwrappingEventLogs'],
      QueryunwrappingEventLogsArgs,
      MeshContext
    >;
    /** null **/
    vanchorWithdrawalLog: InContextSdkMethod<
      Query['vanchorWithdrawalLog'],
      QueryvanchorWithdrawalLogArgs,
      MeshContext
    >;
    /** null **/
    vanchorWithdrawalLogs: InContextSdkMethod<
      Query['vanchorWithdrawalLogs'],
      QueryvanchorWithdrawalLogsArgs,
      MeshContext
    >;
    /** null **/
    vanchorWithdrawal: InContextSdkMethod<
      Query['vanchorWithdrawal'],
      QueryvanchorWithdrawalArgs,
      MeshContext
    >;
    /** null **/
    vanchorWithdrawals: InContextSdkMethod<
      Query['vanchorWithdrawals'],
      QueryvanchorWithdrawalsArgs,
      MeshContext
    >;
    /** null **/
    vanchorWithdrawalByToken: InContextSdkMethod<
      Query['vanchorWithdrawalByToken'],
      QueryvanchorWithdrawalByTokenArgs,
      MeshContext
    >;
    /** null **/
    vanchorWithdrawalByTokens: InContextSdkMethod<
      Query['vanchorWithdrawalByTokens'],
      QueryvanchorWithdrawalByTokensArgs,
      MeshContext
    >;
    /** null **/
    vanchorWithdrawalEvery15Min: InContextSdkMethod<
      Query['vanchorWithdrawalEvery15Min'],
      QueryvanchorWithdrawalEvery15MinArgs,
      MeshContext
    >;
    /** null **/
    vanchorWithdrawalEvery15Mins: InContextSdkMethod<
      Query['vanchorWithdrawalEvery15Mins'],
      QueryvanchorWithdrawalEvery15MinsArgs,
      MeshContext
    >;
    /** null **/
    vanchorWithdrawalByTokenEvery15Min: InContextSdkMethod<
      Query['vanchorWithdrawalByTokenEvery15Min'],
      QueryvanchorWithdrawalByTokenEvery15MinArgs,
      MeshContext
    >;
    /** null **/
    vanchorWithdrawalByTokenEvery15Mins: InContextSdkMethod<
      Query['vanchorWithdrawalByTokenEvery15Mins'],
      QueryvanchorWithdrawalByTokenEvery15MinsArgs,
      MeshContext
    >;
    /** null **/
    vanchorWithdrawalEveryDay: InContextSdkMethod<
      Query['vanchorWithdrawalEveryDay'],
      QueryvanchorWithdrawalEveryDayArgs,
      MeshContext
    >;
    /** null **/
    vanchorWithdrawalEveryDays: InContextSdkMethod<
      Query['vanchorWithdrawalEveryDays'],
      QueryvanchorWithdrawalEveryDaysArgs,
      MeshContext
    >;
    /** null **/
    vanchorWithdrawalByTokenEveryDay: InContextSdkMethod<
      Query['vanchorWithdrawalByTokenEveryDay'],
      QueryvanchorWithdrawalByTokenEveryDayArgs,
      MeshContext
    >;
    /** null **/
    vanchorWithdrawalByTokenEveryDays: InContextSdkMethod<
      Query['vanchorWithdrawalByTokenEveryDays'],
      QueryvanchorWithdrawalByTokenEveryDaysArgs,
      MeshContext
    >;
    /** null **/
    vanchorDeposit: InContextSdkMethod<
      Query['vanchorDeposit'],
      QueryvanchorDepositArgs,
      MeshContext
    >;
    /** null **/
    vanchorDeposits: InContextSdkMethod<
      Query['vanchorDeposits'],
      QueryvanchorDepositsArgs,
      MeshContext
    >;
    /** null **/
    vanchorDepositByToken: InContextSdkMethod<
      Query['vanchorDepositByToken'],
      QueryvanchorDepositByTokenArgs,
      MeshContext
    >;
    /** null **/
    vanchorDepositByTokens: InContextSdkMethod<
      Query['vanchorDepositByTokens'],
      QueryvanchorDepositByTokensArgs,
      MeshContext
    >;
    /** null **/
    vanchorDepositEvery15Min: InContextSdkMethod<
      Query['vanchorDepositEvery15Min'],
      QueryvanchorDepositEvery15MinArgs,
      MeshContext
    >;
    /** null **/
    vanchorDepositEvery15Mins: InContextSdkMethod<
      Query['vanchorDepositEvery15Mins'],
      QueryvanchorDepositEvery15MinsArgs,
      MeshContext
    >;
    /** null **/
    vanchorDepositByTokenEvery15Min: InContextSdkMethod<
      Query['vanchorDepositByTokenEvery15Min'],
      QueryvanchorDepositByTokenEvery15MinArgs,
      MeshContext
    >;
    /** null **/
    vanchorDepositByTokenEvery15Mins: InContextSdkMethod<
      Query['vanchorDepositByTokenEvery15Mins'],
    ...
    >;
    /** null **/
    vanchorDepositLogs: InContextSdkMethod<
      Query['vanchorDepositLogs'],
      QueryvanchorDepositLogsArgs,
      MeshContext
    >;
    /** null **/
    vanchorTransferLog: InContextSdkMethod<
      Query['vanchorTransferLog'],
      QueryvanchorTransferLogArgs,
      MeshContext
    >;
    /** null **/
    vanchorTransferLogs: InContextSdkMethod<
      Query['vanchorTransferLogs'],
      QueryvanchorTransferLogsArgs,
      MeshContext
    >;
    /** null **/
    vanchorVolume: InContextSdkMethod<
      Query['vanchorVolume'],
      QueryvanchorVolumeArgs,
      MeshContext
    >;
    /** null **/
    vanchorVolumes: InContextSdkMethod<
      Query['vanchorVolumes'],
      QueryvanchorVolumesArgs,
      MeshContext
    >;
    /** null **/
    vanchorVolumeByToken: InContextSdkMethod<
      Query['vanchorVolumeByToken'],
      QueryvanchorVolumeByTokenArgs,
      MeshContext
    >;
    /** null **/
    vanchorVolumeByTokens: InContextSdkMethod<
      Query['vanchorVolumeByTokens'],
      QueryvanchorVolumeByTokensArgs,
      MeshContext
    >;
    /** null **/
    vanchorVolumeEvery15Min: InContextSdkMethod<
      Query['vanchorVolumeEvery15Min'],
      QueryvanchorVolumeEvery15MinArgs,
      MeshContext
    >;
    /** null **/
    vanchorVolumeEvery15Mins: InContextSdkMethod<
      Query['vanchorVolumeEvery15Mins'],
      QueryvanchorVolumeEvery15MinsArgs,
      MeshContext
    >;
    /** null **/
    vanchorVolumeByTokenEvery15Min: InContextSdkMethod<
      Query['vanchorVolumeByTokenEvery15Min'],
      QueryvanchorVolumeByTokenEvery15MinArgs,
      MeshContext
    >;
    /** null **/
    vanchorVolumeByTokenEvery15Mins: InContextSdkMethod<
      Query['vanchorVolumeByTokenEvery15Mins'],
      QueryvanchorVolumeByTokenEvery15MinsArgs,
      MeshContext
    >;
    /** null **/
    vanchorVolumeEveryDay: InContextSdkMethod<
      Query['vanchorVolumeEveryDay'],
      QueryvanchorVolumeEveryDayArgs,
      MeshContext
    >;
    /** null **/
    vanchorVolumeEveryDays: InContextSdkMethod<
      Query['vanchorVolumeEveryDays'],
      QueryvanchorVolumeEveryDaysArgs,
      MeshContext
    >;
    /** null **/
    vanchorVolumeByTokenEveryDay: InContextSdkMethod<
      Query['vanchorVolumeByTokenEveryDay'],
      QueryvanchorVolumeByTokenEveryDayArgs,
      MeshContext
    >;
    /** null **/
    vanchorVolumeByTokenEveryDays: InContextSdkMethod<
      Query['vanchorVolumeByTokenEveryDays'],
  ...
  export type SubscriptionSdk = {
    /** null **/
    edgeAddition: InContextSdkMethod<
      Subscription['edgeAddition'],
      SubscriptionedgeAdditionArgs,
      MeshContext
    >;
    /** null **/
    edgeAdditions: InContextSdkMethod<
      Subscription['edgeAdditions'],
    ...
    /** null **/
    newCommitment: InContextSdkMethod<
      Subscription['newCommitment'],
      SubscriptionnewCommitmentArgs,
      MeshContext
    >;
    /** null **/
    newCommitments: InContextSdkMethod<
      Subscription['newCommitments'],
      SubscriptionnewCommitmentsArgs,
      MeshContext
    >;
    /** null **/
    newNullifier: InContextSdkMethod<
      Subscription['newNullifier'],
      SubscriptionnewNullifierArgs,
      MeshContext
    >;
    /** null **/
    newNullifiers: InContextSdkMethod<
      Subscription['newNullifiers'],
    ...
    publicKey: InContextSdkMethod<
      ...
      SubscriptionpublicKeyArgs,
      MeshContext
    >;
    /** null **/
    publicKeys: InContextSdkMethod<
      Subscription['publicKeys'],
    ...
    /** null **/
    externalData: InContextSdkMethod<
      Subscription['externalData'],
      SubscriptionexternalDataArgs,
      MeshContext
    >;
    /** null **/
    externalDatas: InContextSdkMethod<
      Subscription['externalDatas'],
      SubscriptionexternalDatasArgs,
      MeshContext
    >;
    /** null **/
    publicInputs: InContextSdkMethod<
      Subscription['publicInputs'],
      SubscriptionpublicInputsArgs,
      MeshContext
    >;
    /** null **/
    encryptions: InContextSdkMethod<
      Subscription['encryptions'],
      SubscriptionencryptionsArgs,
      MeshContext
    >;
    /** null **/
    shieldedTransaction: InContextSdkMethod<
      Subscription['shieldedTransaction'],
      SubscriptionshieldedTransactionArgs,
      MeshContext
    >;
    /** null **/
    shieldedTransactions: InContextSdkMethod<
    ...
    /** null **/
    vanchorTotalValueLocked: InContextSdkMethod<
      Subscription['vanchorTotalValueLocked'],
      SubscriptionvanchorTotalValueLockedArgs,
      MeshContext
    >;
    /** null **/
    vanchorTotalValueLockeds: InContextSdkMethod<
      Subscription['vanchorTotalValueLockeds'],
      SubscriptionvanchorTotalValueLockedsArgs,
      MeshContext
    >;
    /** null **/
    vanchorTotalValueLockedByToken: InContextSdkMethod<
      Subscription['vanchorTotalValueLockedByToken'],
      SubscriptionvanchorTotalValueLockedByTokenArgs,
      MeshContext
    >;
    /** null **/
    vanchorTotalValueLockedByTokens: InContextSdkMethod<
      Subscription['vanchorTotalValueLockedByTokens'],
      SubscriptionvanchorTotalValueLockedByTokensArgs,
      MeshContext
    >;
    /** null **/
    vanchorTotalValueLockedEvery15Min: InContextSdkMethod<
      Subscription['vanchorTotalValueLockedEvery15Min'],
      SubscriptionvanchorTotalValueLockedEvery15MinArgs,
      MeshContext
    >;
    /** null **/
    vanchorTotalValueLockedEvery15Mins: InContextSdkMethod<
      Subscription['vanchorTotalValueLockedEvery15Mins'],
      SubscriptionvanchorTotalValueLockedEvery15MinsArgs,
      MeshContext
    >;
    /** null **/
    vanchorTotalValueLockedByTokenEvery15Min: InContextSdkMethod<
      Subscription['vanchorTotalValueLockedByTokenEvery15Min'],
      SubscriptionvanchorTotalValueLockedByTokenEvery15MinArgs,
      MeshContext
    >;
    /** null **/
    vanchorTotalValueLockedByTokenEvery15Mins: InContextSdkMethod<
      Subscription['vanchorTotalValueLockedByTokenEvery15Mins'],
      SubscriptionvanchorTotalValueLockedByTokenEvery15MinsArgs,
      MeshContext
    >;
    /** null **/
    vanchorTotalValueLockedByDay: InContextSdkMethod<
      Subscription['vanchorTotalValueLockedByDay'],
      SubscriptionvanchorTotalValueLockedByDayArgs,
      MeshContext
    >;
    /** null **/
    vanchorTotalValueLockedByDays: InContextSdkMethod<
      Subscription['vanchorTotalValueLockedByDays'],
      SubscriptionvanchorTotalValueLockedByDaysArgs,
      MeshContext
    >;
    /** null **/
    vanchorTotalValueLockedByTokenByDay: InContextSdkMethod<
      Subscription['vanchorTotalValueLockedByTokenByDay'],
      SubscriptionvanchorTotalValueLockedByTokenByDayArgs,
      MeshContext
    >;
    /** null **/
    vanchorTotalValueLockedByTokenByDays: InContextSdkMethod<
      Subscription['vanchorTotalValueLockedByTokenByDays'],
      SubscriptionvanchorTotalValueLockedByTokenByDaysArgs,
      MeshContext
    >;
    /** null **/
    vanchorTotalRelayerFee: InContextSdkMethod<
      Subscription['vanchorTotalRelayerFee'],
      SubscriptionvanchorTotalRelayerFeeArgs,
      MeshContext
    >;
    /** null **/
    vanchorTotalRelayerFees: InContextSdkMethod<
      Subscription['vanchorTotalRelayerFees'],
      SubscriptionvanchorTotalRelayerFeesArgs,
      MeshContext
    >;
    /** null **/
    vanchorTotalRelayerFeeByToken: InContextSdkMethod<
      Subscription['vanchorTotalRelayerFeeByToken'],
      SubscriptionvanchorTotalRelayerFeeByTokenArgs,
      MeshContext
    >;
    /** null **/
    vanchorTotalRelayerFeeByTokens: InContextSdkMethod<
      Subscription['vanchorTotalRelayerFeeByTokens'],
      SubscriptionvanchorTotalRelayerFeeByTokensArgs,
      MeshContext
    >;
    /** null **/
    vanchorTotalRelayerFee15Min: InContextSdkMethod<
      Subscription['vanchorTotalRelayerFee15Min'],
      SubscriptionvanchorTotalRelayerFee15MinArgs,
      MeshContext
    >;
    /** null **/
    vanchorTotalRelayerFee15Mins: InContextSdkMethod<
      Subscription['vanchorTotalRelayerFee15Mins'],
      SubscriptionvanchorTotalRelayerFee15MinsArgs,
      MeshContext
    >;
    /** null **/
    vanchorTotalRelayerFeeByTokenEvery15Min: InContextSdkMethod<
      Subscription['vanchorTotalRelayerFeeByTokenEvery15Min'],
      SubscriptionvanchorTotalRelayerFeeByTokenEvery15MinArgs,
      MeshContext
    >;
    /** null **/
    vanchorTotalRelayerFeeByTokenEvery15Mins: InContextSdkMethod<
      Subscription['vanchorTotalRelayerFeeByTokenEvery15Mins'],
      SubscriptionvanchorTotalRelayerFeeByTokenEvery15MinsArgs,
      MeshContext
    >;
    /** null **/
    vanchorTotalWrappingFee: InContextSdkMethod<
      Subscription['vanchorTotalWrappingFee'],
      SubscriptionvanchorTotalWrappingFeeArgs,
      MeshContext
    >;
    /** null **/
    vanchorTotalWrappingFees: InContextSdkMethod<
      Subscription['vanchorTotalWrappingFees'],
      SubscriptionvanchorTotalWrappingFeesArgs,
      MeshContext
    >;
    /** null **/
    vanchorTotalWrappingFeeByToken: InContextSdkMethod<
      Subscription['vanchorTotalWrappingFeeByToken'],
      SubscriptionvanchorTotalWrappingFeeByTokenArgs,
      MeshContext
    >;
    /** null **/
    vanchorTotalWrappingFeeByTokens: InContextSdkMethod<
      Subscription['vanchorTotalWrappingFeeByTokens'],
      SubscriptionvanchorTotalWrappingFeeByTokensArgs,
      MeshContext
    >;
    /** null **/
    vanchorTotalWrappingFee15Min: InContextSdkMethod<
      Subscription['vanchorTotalWrappingFee15Min'],
      SubscriptionvanchorTotalWrappingFee15MinArgs,
      MeshContext
    >;
    /** null **/
    vanchorTotalWrappingFee15Mins: InContextSdkMethod<
      Subscription['vanchorTotalWrappingFee15Mins'],
      SubscriptionvanchorTotalWrappingFee15MinsArgs,
      MeshContext
    >;
    /** null **/
    vanchorTotalWrappingFeeByTokenEvery15Min: InContextSdkMethod<
      Subscription['vanchorTotalWrappingFeeByTokenEvery15Min'],
      SubscriptionvanchorTotalWrappingFeeByTokenEvery15MinArgs,
      MeshContext
    >;
    /** null **/
    vanchorTotalWrappingFeeByTokenEvery15Mins: InContextSdkMethod<
      Subscription['vanchorTotalWrappingFeeByTokenEvery15Mins'],
      SubscriptionvanchorTotalWrappingFeeByTokenEvery15MinsArgs,
      MeshContext
    >;
    /** null **/
    wrappingEventLog: InContextSdkMethod<
      Subscription['wrappingEventLog'],
      SubscriptionwrappingEventLogArgs,
      MeshContext
    >;
    /** null **/
    wrappingEventLogs: InContextSdkMethod<
      Subscription['wrappingEventLogs'],
      SubscriptionwrappingEventLogsArgs,
      MeshContext
    >;
    /** null **/
    unwrappingEventLog: InContextSdkMethod<
      Subscription['unwrappingEventLog'],
      SubscriptionunwrappingEventLogArgs,
      MeshContext
    >;
    /** null **/
    unwrappingEventLogs: InContextSdkMethod<
      Subscription['unwrappingEventLogs'],
      SubscriptionunwrappingEventLogsArgs,
      MeshContext
    >;
    /** null **/
    vanchorWithdrawalLog: InContextSdkMethod<
      Subscription['vanchorWithdrawalLog'],
      SubscriptionvanchorWithdrawalLogArgs,
      MeshContext
    >;
    /** null **/
    vanchorWithdrawalLogs: InContextSdkMethod<
      Subscription['vanchorWithdrawalLogs'],
      SubscriptionvanchorWithdrawalLogsArgs,
      MeshContext
    >;
    /** null **/
    vanchorWithdrawal: InContextSdkMethod<
      Subscription['vanchorWithdrawal'],
      SubscriptionvanchorWithdrawalArgs,
      MeshContext
    >;
    /** null **/
    vanchorWithdrawals: InContextSdkMethod<
      Subscription['vanchorWithdrawals'],
      SubscriptionvanchorWithdrawalsArgs,
      MeshContext
    >;
    /** null **/
    vanchorWithdrawalByToken: InContextSdkMethod<
      Subscription['vanchorWithdrawalByToken'],
      SubscriptionvanchorWithdrawalByTokenArgs,
      MeshContext
    >;
    /** null **/
    vanchorWithdrawalByTokens: InContextSdkMethod<
      Subscription['vanchorWithdrawalByTokens'],
      SubscriptionvanchorWithdrawalByTokensArgs,
      MeshContext
    >;
    /** null **/
    vanchorWithdrawalEvery15Min: InContextSdkMethod<
      Subscription['vanchorWithdrawalEvery15Min'],
      SubscriptionvanchorWithdrawalEvery15MinArgs,
      MeshContext
    >;
    /** null **/
    vanchorWithdrawalEvery15Mins: InContextSdkMethod<
      Subscription['vanchorWithdrawalEvery15Mins'],
      SubscriptionvanchorWithdrawalEvery15MinsArgs,
      MeshContext
    >;
    /** null **/
    vanchorWithdrawalByTokenEvery15Min: InContextSdkMethod<
      Subscription['vanchorWithdrawalByTokenEvery15Min'],
      SubscriptionvanchorWithdrawalByTokenEvery15MinArgs,
      MeshContext
    >;
    /** null **/
    vanchorWithdrawalByTokenEvery15Mins: InContextSdkMethod<
      Subscription['vanchorWithdrawalByTokenEvery15Mins'],
      SubscriptionvanchorWithdrawalByTokenEvery15MinsArgs,
      MeshContext
    >;
    /** null **/
    vanchorWithdrawalEveryDay: InContextSdkMethod<
      Subscription['vanchorWithdrawalEveryDay'],
      SubscriptionvanchorWithdrawalEveryDayArgs,
      MeshContext
    >;
    /** null **/
    vanchorWithdrawalEveryDays: InContextSdkMethod<
      Subscription['vanchorWithdrawalEveryDays'],
      SubscriptionvanchorWithdrawalEveryDaysArgs,
      MeshContext
    >;
    /** null **/
    vanchorWithdrawalByTokenEveryDay: InContextSdkMethod<
      Subscription['vanchorWithdrawalByTokenEveryDay'],
      SubscriptionvanchorWithdrawalByTokenEveryDayArgs,
      MeshContext
    >;
    /** null **/
    vanchorWithdrawalByTokenEveryDays: InContextSdkMethod<
      Subscription['vanchorWithdrawalByTokenEveryDays'],
      SubscriptionvanchorWithdrawalByTokenEveryDaysArgs,
      MeshContext
    >;
    /** null **/
    vanchorDeposit: InContextSdkMethod<
      Subscription['vanchorDeposit'],
      SubscriptionvanchorDepositArgs,
      MeshContext
    >;
    /** null **/
    vanchorDeposits: InContextSdkMethod<
      Subscription['vanchorDeposits'],
      SubscriptionvanchorDepositsArgs,
      MeshContext
    >;
    /** null **/
    vanchorDepositByToken: InContextSdkMethod<
      Subscription['vanchorDepositByToken'],
      SubscriptionvanchorDepositByTokenArgs,
      MeshContext
    >;
    /** null **/
    vanchorDepositByTokens: InContextSdkMethod<
      Subscription['vanchorDepositByTokens'],
      SubscriptionvanchorDepositByTokensArgs,
      MeshContext
    >;
    /** null **/
    vanchorDepositEvery15Min: InContextSdkMethod<
      Subscription['vanchorDepositEvery15Min'],
      SubscriptionvanchorDepositEvery15MinArgs,
      MeshContext
    >;
    /** null **/
    vanchorDepositEvery15Mins: InContextSdkMethod<
      Subscription['vanchorDepositEvery15Mins'],
      SubscriptionvanchorDepositEvery15MinsArgs,
      MeshContext
    >;
    /** null **/
    vanchorDepositByTokenEvery15Min: InContextSdkMethod<
      Subscription['vanchorDepositByTokenEvery15Min'],
    ...
    /** null **/
    vanchorDepositLog: InContextSdkMethod<
      Subscription['vanchorDepositLog'],
      SubscriptionvanchorDepositLogArgs,
      MeshContext
    >;
    /** null **/
    vanchorDepositLogs: InContextSdkMethod<
      Subscription['vanchorDepositLogs'],
      SubscriptionvanchorDepositLogsArgs,
      MeshContext
    >;
    /** null **/
    vanchorTransferLog: InContextSdkMethod<
      Subscription['vanchorTransferLog'],
      SubscriptionvanchorTransferLogArgs,
      MeshContext
    >;
    /** null **/
    vanchorTransferLogs: InContextSdkMethod<
      Subscription['vanchorTransferLogs'],
      SubscriptionvanchorTransferLogsArgs,
      MeshContext
    >;
    /** null **/
    vanchorVolume: InContextSdkMethod<
      Subscription['vanchorVolume'],
      SubscriptionvanchorVolumeArgs,
      MeshContext
    >;
    /** null **/
    vanchorVolumes: InContextSdkMethod<
      Subscription['vanchorVolumes'],
      SubscriptionvanchorVolumesArgs,
      MeshContext
    >;
    /** null **/
    vanchorVolumeByToken: InContextSdkMethod<
      Subscription['vanchorVolumeByToken'],
      SubscriptionvanchorVolumeByTokenArgs,
      MeshContext
    >;
    /** null **/
    vanchorVolumeByTokens: InContextSdkMethod<
      Subscription['vanchorVolumeByTokens'],
      SubscriptionvanchorVolumeByTokensArgs,
      MeshContext
    >;
    /** null **/
    vanchorVolumeEvery15Min: InContextSdkMethod<
      Subscription['vanchorVolumeEvery15Min'],
      SubscriptionvanchorVolumeEvery15MinArgs,
      MeshContext
    >;
    /** null **/
    vanchorVolumeEvery15Mins: InContextSdkMethod<
      Subscription['vanchorVolumeEvery15Mins'],
      SubscriptionvanchorVolumeEvery15MinsArgs,
      MeshContext
    >;
    /** null **/
    vanchorVolumeByTokenEvery15Min: InContextSdkMethod<
      Subscription['vanchorVolumeByTokenEvery15Min'],
      SubscriptionvanchorVolumeByTokenEvery15MinArgs,
      MeshContext
    >;
    /** null **/
    vanchorVolumeByTokenEvery15Mins: InContextSdkMethod<
      Subscription['vanchorVolumeByTokenEvery15Mins'],
      SubscriptionvanchorVolumeByTokenEvery15MinsArgs,
      MeshContext
    >;
    /** null **/
    vanchorVolumeEveryDay: InContextSdkMethod<
      Subscription['vanchorVolumeEveryDay'],
      SubscriptionvanchorVolumeEveryDayArgs,
      MeshContext
    >;
    /** null **/
    vanchorVolumeEveryDays: InContextSdkMethod<
      Subscription['vanchorVolumeEveryDays'],
      SubscriptionvanchorVolumeEveryDaysArgs,
      MeshContext
    >;
    /** null **/
    vanchorVolumeByTokenEveryDay: InContextSdkMethod<
      Subscription['vanchorVolumeByTokenEveryDay'],
      SubscriptionvanchorVolumeByTokenEveryDayArgs,
      MeshContext
    >;
    /** null **/
    vanchorVolumeByTokenEveryDays: InContextSdkMethod<
      Subscription['vanchorVolumeByTokenEveryDays'],
