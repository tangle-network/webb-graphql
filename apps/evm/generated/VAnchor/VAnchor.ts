...
export class VAnchor__merkleForestResult {
  value0: i32;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class VAnchor__subtreesResult {
  value0: i32;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class VAnchor extends ethereum.SmartContract {
  ...
  currSubtreeIndex(): BigInt {
    let result = super.call(
      "currSubtreeIndex",
      "currSubtreeIndex():(uint32)",
      []
    );
  ...
  try_currSubtreeIndex(): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "currSubtreeIndex",
      "currSubtreeIndex():(uint32)",
      []
  ...
  forestLevels(): BigInt {
    let result = super.call("forestLevels", "forestLevels():(uint32)", []);

    return result[0].toBigInt();
  }

  try_forestLevels(): ethereum.CallResult<BigInt> {
    let result = super.tryCall("forestLevels", "forestLevels():(uint32)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    let value = result.value;
  ...
  getLastSubtreeRoot(_subtreeId: BigInt): BigInt {
    let result = super.call(
      "getLastSubtreeRoot",
      "getLastSubtreeRoot(uint256):(uint256)",
      [ethereum.Value.fromUnsignedBigInt(_subtreeId)]
    );

    return result[0].toBigInt();
  }

  try_getLastSubtreeRoot(_subtreeId: BigInt): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "getLastSubtreeRoot",
      "getLastSubtreeRoot(uint256):(uint256)",
      [ethereum.Value.fromUnsignedBigInt(_subtreeId)]
  ...
  isKnownSubtreeRoot(_subtreeId: BigInt, _root: BigInt): boolean {
    let result = super.call(
      "isKnownSubtreeRoot",
      "isKnownSubtreeRoot(uint256,uint256):(bool)",
      [
        ethereum.Value.fromUnsignedBigInt(_subtreeId),
        ethereum.Value.fromUnsignedBigInt(_root)
      ]
  ...
  merkleForest(): VAnchor__merkleForestResult {
    let result = super.call(
      "merkleForest",
      "merkleForest():(uint8,uint256,uint32,uint32)",
      []
    );

    return new VAnchor__merkleForestResult(
      result[0].toI32(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt()
  ...
  try_merkleForest(): ethereum.CallResult<VAnchor__merkleForestResult> {
    let result = super.tryCall(
      "merkleForest",
      "merkleForest():(uint8,uint256,uint32,uint32)",
      []
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new VAnchor__merkleForestResult(
        value[0].toI32(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt()
  ...
  numSubtreeElements(): BigInt {
    let result = super.call(
      "numSubtreeElements",
      "numSubtreeElements():(uint32)",
      []
    );
  ...
  try_numSubtreeElements(): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "numSubtreeElements",
      "numSubtreeElements():(uint32)",
      []
  ...
  subtreeLevels(): BigInt {
    let result = super.call("subtreeLevels", "subtreeLevels():(uint32)", []);

    return result[0].toBigInt();
  }

  try_subtreeLevels(): ethereum.CallResult<BigInt> {
    let result = super.tryCall("subtreeLevels", "subtreeLevels():(uint32)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    let value = result.value;
  ...
  subtrees(param0: BigInt): VAnchor__subtreesResult {
    let result = super.call(
      "subtrees",
      "subtrees(uint256):(uint8,uint256,uint32,uint32)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
    );

    return new VAnchor__subtreesResult(
      result[0].toI32(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt()
  ...
  try_subtrees(param0: BigInt): ethereum.CallResult<VAnchor__subtreesResult> {
    let result = super.tryCall(
      "subtrees",
      "subtrees(uint256):(uint8,uint256,uint32,uint32)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
...
export class ConstructorCall__Inputs {
  ...
  get _forestLevels(): BigInt {
    return this._call.inputValues[1].value.toBigInt();
  }

  get _subtreeLevels(): BigInt {
