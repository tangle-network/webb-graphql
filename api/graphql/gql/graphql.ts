...
export interface IQuery {
  ...
  bridgeSide(
    network: string,
    contractAddress: string,
  ): BridgeSide | Promise<BridgeSide>;
  bridgesDayData(
    filter?: Nullable<BridgesDayDataInput>,
  ): DayData[] | Promise<DayData[]>;
  ...
  depositTransactions(
    filter?: Nullable<TransactionFilterInput>,
  ): DepositTx[] | Promise<DepositTx[]>;
  withdrawTransactions(
    filter?: Nullable<TransactionFilterInput>,
  ): WithdrawTx[] | Promise<WithdrawTx[]>;
  transferTransactions(
    filter?: Nullable<TransactionFilterInput>,
  ): TransferTx[] | Promise<TransferTx[]>;
}
