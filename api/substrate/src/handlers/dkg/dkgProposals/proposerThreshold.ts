...
export async function ensureProposalThreshold(blockNumber: string, idx: number) {
...
export async function createProposerThreshold(thresholdValue: string, { blockNumber, idx }: EventMetaData) {
